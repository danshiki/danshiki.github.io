...
let pricePartInIDR  = ['Rp.400.000', 'Rp.600.000', 'Rp.800.000', 'Rp.1000.000'];
let pricePartInUSD  = ['$59', '$79', '$99', '$119'];

let bgPartName      = ['solidcolor', 'blurry', 'detailed', 'blender'];
let priceBgInIDR    = ['+Rp.0', '+Rp.400.000', '+Rp.800.000', '+Rp.1800.000'];
...
function ForwardToForm() {
    ...
    let Parts             = "entry.914479690";
    let Bg                = "entry.559237816";
    let Canvas            = "entry.747307520";
    let Commercial        = "entry.1517738649";
    let Currency          = "entry.2099906957";
    let Price             = "entry.2113941122";
    ...
    // This will autofill the destined lists
     window.open(`https://docs.google.com/forms/d/e/1FAIpQLSc81gECH4NAkOxrwM3bl4lgQV_RGuN4843-BjAvUPzZ7r_fDw/viewform?${Parts}=${fParts[iParts]}&${Bg}=${fBg[iBg]}&${Canvas}=${fCanvas[iCanvas]}&${Commercial}=${fCommercial}&${Currency}=${fCurrency[iCurrency]}&${Price}=${updatedTotalPrice}`
...
function SendEmail(){
    ...
    if (Checkform(form)){
        ...
        // Send form
        form.action = "https://formsubmit.co/danshiki17@gmail.com";
        form.method = "POST"
        form.submit();
